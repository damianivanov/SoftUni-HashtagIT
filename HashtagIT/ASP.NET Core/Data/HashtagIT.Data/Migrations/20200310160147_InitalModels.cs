        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IGFullname = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IGUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IGUsers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HashtagSets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HashtagSets_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HashtagSets_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Hashtags_HashtagSets_HashtagSetId",
                        column: x => x.HashtagSetId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Posts_IGUsers_IGUserId",
                        column: x => x.IGUserId,
                        principalTable: "IGUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Hashtags_HashtagSetId",
                table: "Hashtags",
                column: "HashtagSetId");

            migrationBuilder.CreateIndex(
                name: "IX_Hashtags_IsDeleted",
                table: "Hashtags",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_HashtagSets_CategoryId",
                table: "HashtagSets",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_HashtagSets_IsDeleted",
                table: "HashtagSets",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_HashtagSets_UserId",
                table: "HashtagSets",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_IGUsers_IsDeleted",
                table: "IGUsers",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_IGUsers_UserId",
                table: "IGUsers",
                column: "UserId");
